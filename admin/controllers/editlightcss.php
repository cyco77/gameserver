...
class GameServerControllerEditLightCss extends JControllerLegacy
{
	function editLightCSS()
	{		
		JRequest::setVar( 'view', 'editlightcss' );
	...
	function apply()
	{
		...
		if ($return)
		{
			$this->setRedirect('index.php?option=com_gameserver&controller=editlightcss&view=editLightCSS',  JText::_('File Saved'));
		}
		else {
			$this->setRedirect('index.php?option=com_gameserver&controller=editlightcss&view=editLightCSS', JText::_('Operation Failed').': '.JText::sprintf('Failed to open file for writing'.".", $file));
		}
	}
