...
class bfvietnamRenderer extends abstractRenderer  {
	...
	{	
		...
		{		
			return array(
				new playerValues(JText::_('PLAYERNAME'),'player',alignment::left,false),
	...
	public function renderPlayerList()
	{
		...
		{
			return $this->renderTeamPlayerList('team','1','2');
		}
		else
		{
	...
	{
		$output .= $this->countPlayersBy($this->data['players'],'team','2').' '. JText::_('PLAYERS');
