...
class GameQ_Protocol_teeworlds extends GameQ_Protocol
{
    ...
    public function status()
    {
		...
		$this->r->add('unknown',     $this->p->readString());
		...
		$this->r->add('num_clients', $this->p->readString());
        $this->r->add('max_clients', $this->p->readString());
    ...
    private function players()
    {
        while ($name = $this->p->readString()) {
            ...
            $this->r->addPlayer('clan',  $this->p->readString());
            $this->r->addPlayer('country',  $this->p->readString());
            $this->r->addPlayer('score', $this->p->readString());
            $this->r->addPlayer('player', $this->p->readString());
        }
    }
}
?>
