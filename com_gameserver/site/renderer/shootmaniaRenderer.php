...
require_once(JPATH_SITE.DS.'components'.DS.'com_gameserver'.DS.'script'.DS.'additional'.DS.'shootmania'.DS.'tm2colorparser.inc.php');

class shootmaniaRenderer extends abstractRenderer  {
